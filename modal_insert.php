<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($_POST)) {
            $output = "";
            $modal_name = mysqli_real_escape_string($conn,$_POST['modal_name']);
            $modal_address = mysqli_real_escape_string($conn,$_POST['modal_address']);
            $modal_gender = mysqli_real_escape_string($conn,$_POST['modal_gender']);
            $modal_designation = mysqli_real_escape_string($conn,$_POST['modal_designation']);
            $modal_age = mysqli_real_escape_string($conn,$_POST['modal_age']);
            $insert_query = "insert into insert_modal(`Name`,`Address`,`Gender`,`Designation`,`Age`) values('$modal_name','$modal_address','$modal_gender','$modal_designation','$modal_age')";
